...
# -*- coding: utf-8 -*-
#
# EngCoolProp documentation build configuration file, created by
...
proj = os.path.join(up_one, 'engcoolprop')

if here not in sys.path[:3]:
    sys.path.insert(0, here)
if up_one not in sys.path[:3]:
    sys.path.insert(0, up_one)
if proj not in sys.path[:3]:
    sys.path.insert(0, proj)


target_file = os.path.join( up_one, 'engcoolprop','_version.py')
...
htmlhelp_basename = 'EngCoolPropdoc'
...
latex_documents = [
  (master_doc, 'EngCoolProp.tex', u'EngCoolProp Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'EngCoolProp Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'EngCoolProp', u'EngCoolProp Documentation',
   author, 'EngCoolProp', 'One line description of project.',
   'Miscellaneous'),
]
